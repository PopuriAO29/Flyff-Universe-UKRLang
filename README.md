...
The project was started in February 21, 2026 and the official localization repository can be found [here](https://github.com/gala-lab/flyff-universe-translations).

## What is this?
I started to make Ukrainian language in the favor of the Russo-Ukrainian war. Many protesters of Ukraine people that even destroyed, bombing, and even more.
...
Flyff Universe also offers **Russian (Русский)**, although they will be kept as it is. The idea for me is we should add Ukrainian language in the favor of Russo-Ukrainian war, including it's Presdient of Ukraine (Zelenskyy).
...
Gala Lab are also provided the localization repository of Flyff Universe. In case, We are not ready yet to add the language as because we cannot add languages indefinite future.
